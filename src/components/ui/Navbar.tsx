...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-10 transition-transform duration-300 ${
      ...
      <div className="bg-bg0 text-fg1 flex flex-wrap items-center mx-auto p-4 drop-shadow-md">
        <ul className="ml-auto flex flex-row">
          <li className="mr-6 hover:text-blue-light transition-colors duration-200">
